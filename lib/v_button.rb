def handle_button place_id, name, s_link, group_id, user_id
  ...
  when 0
    ...
    { label: '🌹 獻花支持', type: 'uri', uri: URI.escape(L_SPONSOR) }
    # if group_id
