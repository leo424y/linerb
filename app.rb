        ...
        if m.end_with?(*suffixes) && (name != '')
          ...
          begin
            ...
            unless place_id.nil?
              ...
              place_id_url = "https://maps.googleapis.com/maps/api/place/details/json?placeid=#{place_id}&fields=name,rating,opening_hours&key=#{gmap_key}"
